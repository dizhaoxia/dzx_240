import { Sparkles, Play, Clock, Target, Trophy } from "lucide-react"
      ...
      <div className="animate-slide-up text-center max-w-lg">
        ...
        <div className="mt-12 grid grid-cols-3 gap-3">
          <div className="glass-card rounded-xl p-4 text-center">
            ...
            <div className="text-neon-orange font-bold">15秒</div>
          </div>
          <div className="glass-card rounded-xl p-4 text-center">
            <Target className="w-6 h-6 text-neon-purple mx-auto mb-2" />
            <div className="text-sm text-gray-400">关卡设置</div>
            <div className="text-neon-purple font-bold">5关</div>
            <div className="text-xs text-gray-500 mt-1">每关5题</div>
          </div>
          <div className="glass-card rounded-xl p-4 text-center">
            <Trophy className="w-6 h-6 text-neon-cyan mx-auto mb-2" />
            <div className="text-sm text-gray-400">每题得分</div>
